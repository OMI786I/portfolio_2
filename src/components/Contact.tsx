        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          ...
          <form ref={form} onSubmit={handleSubmit(onSubmit)}>
            <div className="bg-[#93B1A6] text-white p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
              ...
              <textarea
                className="w-full h-60 text-gray-100 placeholder-gray-100 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-md border border-gray-200 focus:outline-none pl-4 mb-10"
                placeholder="Message"
                {...register("message", { required: true })}
              />
              <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-indigo-800 bg-[#040D12] shadow-sm">
                Send
              </button>
            </div>
          </form>
